...
\[
Z(\omega^{i+1}) = Z(\omega^i)\cdot \frac{ (a_i + \beta \cdot \mathrm{id}_{a,i} + \gamma) (b_i + \beta \cdot \mathrm{id}_{b,i} + \gamma) (c_i + \beta \cdot \mathrm{id}_{c,i} + \gamma) }{ (a_i + \beta \cdot \sigma_{a,i} + \gamma) (b_i + \beta \cdot \sigma_{b,i} + \gamma) (c_i + \beta \cdot \sigma_{c,i} + \gamma) }.
\]
